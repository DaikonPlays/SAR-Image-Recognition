...
class ResNet8(nn.Module):
    def __init__(self, input_channels, out_classes, quantization=False, act_int=0, act_dec=0, e2cnn_size=1 ):
        ...
        self.conv = Convolution2D(input_channels, structure[0], k_size=3, stride=1, padding=0, with_bn=False, with_relu=True, quantization=quantization, int_bits=act_int, dec_bits=act_dec)
        ...
        self.classifier = FullyConnected(structure[3], out_classes, with_relu=False, quantization=quantization, int_bits=act_int, dec_bits=act_dec)
