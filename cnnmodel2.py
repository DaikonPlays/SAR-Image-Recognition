...
def main():
    ...
    # dataset1, dataset2 = random_split(dataset, [train_size, test_size])
    ...
    model.conv1 = nn.Conv2d(1, 64, kernel_size=model.conv1.kernel_size, stride=model.conv1.kernel_size, padding=model.conv1.padding,bias=False)
